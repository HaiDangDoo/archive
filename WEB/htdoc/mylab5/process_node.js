// import thư viện
const express=require('express');//→ Import thư viện Express để tạo server web. → Express giúp tạo API, xử lý request và response dễ dàng.
const session=require('express-session');
const crypto=require('crypto');
const db=require('./db'); //ketnoi với database
